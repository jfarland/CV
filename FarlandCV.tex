...
\begin{rSubsection}{AI for Genomics Study}{}{Senior Data Scientst}{Boston, Massachusetts}
...
% \begin{rSubsection}{Genomics Study for Large Research Hospital}{}{Data Scientist}{Boston, Massachusetts}
% \item[] Built a classifier to correctly predict cancer diagnosis using genomics data with 50k features
% \item[] Improved AUC from 0.6 to 0.79 by preprocessing genomics data with autoencoder and postprocessing with a metalearner
% \end{rSubsection}
