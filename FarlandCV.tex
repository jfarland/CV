...
\address{\href{https://www.youtube.com/watch?v=N0gyDVUFPlg}{TimeGPT Launch Event} \\
		 \href{https://github.com/h2oai/h2o_genai_training}{Gen AI Training Course} \\
...
\begin{itemize}
	\item Leadership
		...
		\item Lead and grew an interdisciplinary team of data scientists, SMEs and software engineers by 2X
		\item Lead the development and delivery of Generative AI Masterclasses for data science leaders and executives at the Fortune 100.
		\end{itemize}
	\item Technical
		\begin{itemize}
		\item Fine-tuned a wide range of LLMs and Embedding models optimized for a range of tasks including Doc QA, Summarization, and Entity Extraction
		\item Developed Generative AI Applications, including `ProposalGPT' which can use advanced Retrieval-Augmented Generation to analyze RFPs for competiveness and automatically compose winning proposal.
		\item Built a state-of-the-art forecasting product using foundational GPT models for time series and other best-of-breed approaches.
		\end{itemize}
...
\begin{itemize}
	...
	\item Customer-facing data science lead for main product line, focusing on state of the art time series and forecasting applications
\end{itemize}
% \item Enhanced AI applications using Data Fusion techniques based on research with the US Department of Defense
...
%\item Client-facing management of data science teams and projects focused on and advanced time series forecasting applications.
...
Computing & Unix-based Systems, Docker, Spark, AWS SageMaker, Databricks, Digital Ocean\\
...
% \begin{rSubsection}{Genomics Study}
% \item[] 
% \end{rSubsection}
